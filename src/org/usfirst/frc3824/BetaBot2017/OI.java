...
public class OI
{
	...
	public OI()
	{
        ...
        SmartDashboard.putData("Chassis Drive Time: Default", new ChassisDriveTime(1.0, 1.0));
        SmartDashboard.putData("Chassis Drive Distance: Two Meters", new ChassisDriveDistance(200.0, 1.0));
        SmartDashboard.putData("Chassis Turn Angle: Right", new ChassisTurnAngle(90, 0.5));
